    ...
    const loadChapters = async () => {
      ...
      try {
        ...
        if (doc && doc.chapters && doc.chapters.length > 0) {
          // chapter แรกเป็น module หลัก, ที่เหลือเป็น lessons
          ...
          setModules([
            {
              ...
              description:
                mainChapter.content.length > 100
                  ? mainChapter.content.slice(0, 100) + "..."
                  : mainChapter.content,
              isCompleted: false,
              isLocked: false,
              estimatedTime: 30,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div
              className={`border rounded-xl p-6 sticky top-8 transition-colors duration-300 ${
                darkMode
                  ? "bg-gray-800 border-gray-700"
                  : "bg-white border-gray-200"
              }`}
