...
import { 
  ...
  TrendingUp, Clock, Target, Star, Settings, ArrowLeft
} from 'lucide-react';
                ...
                {isEditing ? (
                  <>
                    ...
                    <button
                      onClick={handleSave}
                      disabled={isLoading}
                      className="px-4 py-2 bg-yellow-400 text-gray-900 rounded-lg hover:bg-yellow-500 disabled:opacity-50 transition-colors flex items-center"
                    >
                ...
                <div className={`border rounded-xl p-8 transition-colors duration-300 ${
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-xl">
                      ...
                      <button className="px-4 py-2 bg-yellow-400 text-gray-900 rounded-lg hover:bg-yellow-500 transition-colors">
                        Enable
                      </button>
                    </div>
                  </div>
